...
public class CloneServerBuilderRe extends BaseBuilder<CloneSshServerRe, CloneServerBuilderRe> {
    ...
    public CloneServerBuilderRe() {
        super();
    }

    public CloneServerBuilderRe interactiveAuthenticator(KeyboardInteractiveAuthenticator auth) {
        interactiveAuthenticator = auth;
        return this;
    }

    public CloneServerBuilderRe publickeyAuthenticator(PublickeyAuthenticator auth) {
        pubkeyAuthenticator = auth;
        return this;
    }

    @Override
    protected CloneServerBuilderRe fillWithDefaultValues() {
        ...
        if (factory == null) {
            factory = CloneSshServerRe.DEFAULT_SSH_SERVER_FACTORY;
        }
    ...
    @Override
    public CloneSshServerRe build(boolean isFillWithDefaultValues) {
        CloneSshServerRe server = super.build(isFillWithDefaultValues);
    ...
    public static CloneServerBuilderRe builder() {
        return new CloneServerBuilderRe();
    }
}
