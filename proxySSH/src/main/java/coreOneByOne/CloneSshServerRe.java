 ...
 */
public class CloneSshServerRe extends AbstractFactoryManager implements ServerFactoryManager, Closeable {
    public static final Factory<CloneSshServerRe> DEFAULT_SSH_SERVER_FACTORY = CloneSshServerRe::new;
    ...
    public void setShellFactory(InteractiveShellFactory shellFactory) {
     ...
     *
     * @return a newly create {@link org.apache.sshd.server.SshServer} with default configurations
     */
    public static CloneSshServerRe setUpDefaultServer() {
        CloneServerBuilderRe builder = CloneServerBuilderRe.builder();
