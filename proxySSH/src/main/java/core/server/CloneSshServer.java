 ...
 */
public class CloneSshServer extends AbstractFactoryManager implements ServerFactoryManager, Closeable {
    public static final Factory<CloneSshServer> DEFAULT_SSH_SERVER_FACTORY = CloneSshServer::new;
     ...
     */
    public static CloneSshServer setUpDefaultServer() {
        CloneServerBuilder builder = CloneServerBuilder.builder();
