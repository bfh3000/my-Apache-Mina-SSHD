...
//                    }
                    ...
                    SSHClientForEcho client = new SSHClientForEcho(TARGET_REMOTE_IP, USERNAME, PASSWORD);
                    client.create();
                    client.start();

                    sshd.setShellFactory(new EchoShellFactory(client));
                    return result;
                }
            }
        );
